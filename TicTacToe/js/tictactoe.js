...
function placeXOrO(squareNumber) {
  ...
  if (!selectedSquares.some((element) => element.includes(squareNumber))) {
    ...
    if (activePlayer === "X") {
      ...
      select.style.backgroundImage = 'url("images/starfruit.png")';
      // Active player may only be 'X' or 'O' so, if not 'X' it must be 'O'
    } else {
      // If active player is equal to 'O', the o.png is placed in HTML
      select.style.backgroundImage = 'url("images/orange.png")';
    }
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
  ...
  function animateLineDrawing() {
    ...
    c.beginPath();
    // This method moves us to a starting point line
    c.moveTo(x1, y1);
    ...
    c.stroke();
    // This condition checks if we've reached out endpoints.
    if (x1 <= x2 && y1 <= y2) {
  ...
  // This functin clears our canvas after our win line is drawn
  function clear() {
